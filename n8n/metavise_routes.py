...
# ════════════════════════════════════════════════════════════════
# METAVISE — Endpoints
# Projeto: Gerador de criativos para Meta Ads
# ════════════════════════════════════════════════════════════════
...
async def metavise_claude(req: RawClaudeRequest):
    """Endpoint generico para o projeto Metavise.
    
    Recebe system+user prompt do frontend e retorna a resposta bruta do Claude.
    Toda logica de prompt fica no frontend (claudeService.ts).
    """
    try:
...
async def metavise_health():
    """Health check para o projeto Metavise."""
    return {
        "status": "ok",
